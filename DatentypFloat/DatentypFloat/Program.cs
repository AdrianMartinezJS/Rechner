...
namespace DatentypFloat
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.ReadLine();
            EinMehrFachEcho();
            Console.WriteLine("Betätige RETURN zum beenden");
            Console.ReadLine();

        }

        static void EinfachesEcho()
        {
            string eingabe = "";

            Console.WriteLine("Du wirst gleich ein Echo sehen!");

            Console.WriteLine("Sag etwas ;)");
            eingabe = Console.ReadLine();

            Console.WriteLine(eingabe);
        }

        static void ImmerWiederEcho()
        {
            string eingabe = "";

            Console.WriteLine("Du wirst gleich ein Echo sehen!");
            Console.WriteLine("Zum beenden ENDE eingeben.");
